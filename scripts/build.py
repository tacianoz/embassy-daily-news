...
NARRATIVES_PROMPT = (
    ...
    "energia e minerais críticos, decisões de governo com peso real) E "
    "GRANDES MOVIMENTOS DE POLÍTICA INTERNA (crise de governo, protestos de "
    "massa, prisão de líder de oposição, agitação social relevante, decisão "
    "econômica doméstica de peso) vêm ANTES de fatos protocolares, "
    "cerimoniais ou de menor consequência (ex.: a relação Índia–China em "
    "alto nível é mais estratégica que um elogio de autoridade da ONU à "
    "Índia; uma onda de protestos que abala o governo é mais estratégica que "
    "um evento setorial de rotina).\n"
    "COBERTURA OBRIGATÓRIA: o diplomata precisa entender a dinâmica INTERNA "
    "do país onde serve. Sempre que houver movimento relevante de política "
    "ou economia doméstica da Índia (crise política, grandes protestos, "
    "prisões de opositores, mudança ministerial, medida econômica de "
    "impacto), inclua ao menos UM tema sobre ele — mesmo que os demais temas "
    "sejam de agenda externa. Cada tema com:\n"
