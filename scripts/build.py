...
NARRATIVES_PROMPT = (
    ...
    "quanto o fato altera (ou pode alterar) a posição internacional da "
    "Índia, a vida política e econômica do país ou interesses do Brasil. "
    ...
    "COBERTURA: a seleção deve espelhar o dia INTEIRO — agenda externa E "
    "dinâmica interna do país. Havendo movimento doméstico de peso "
    "(político, social ou econômico), ao menos UM tema deve registrá-lo. "
    "Cada tema com:\n"
